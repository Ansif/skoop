...
jQuery("#range-slider").slider({
  ...
  slide: function( event, ui ) {
    ...
    if(ui.value > 50) {
        screenText = '50+';
        $('.pricing-details-wrapper').slideUp();
        $('.pricing-offer-notify-block').hide();
        $('.pricing-line-block-2').addClass('pricing-relative').removeClass('pricing-absolute');
    } else {
        screenText = ui.value;
        $('.pricing-details-wrapper').slideDown();
        $('.pricing-offer-notify-block').show();
        $('.pricing-line-block-2').addClass('pricing-absolute').removeClass('pricing-relative');
    }
